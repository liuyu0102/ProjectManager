    ...
    <div id="item">
        ...
        <div class="product-info">
            <div class="fl preview-wrap">
                <!--放大镜效果-->
                <div class="zoom">
                <#--声明图片集合[{"color":"黑色","url":"http://192.168.25.133/group1/M00/00/00/wKgZhVwSVZqAS3XHAAE3-p-U6dk948.jpg"},
                {"color":"白色","url":"http://192.168.25.133/group1/M00/00/00/wKgZhVwSVe-AOL3SAAFFttKgTwM537.jpg"}]-->
            ...
            <div class="fr itemInfo-wrap">
                ...
                <div class="news"><span>${item.sell_point!goods.goods.caption}</span></div>
                <div class="summary">
